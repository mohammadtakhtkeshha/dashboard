...
import {getJustDate} from "methods/commons";
import {
    isHandlerMethod,
...
function CommentTableComponent({t, comments, publishPage, unconfirmPage, setUnconfirmPage, setPublishPage, selectedCheckBoxes, setSelectedCheckBoxes, commentStatus, handlePagination, publishedComments, unconfirmedComments, totalPublishPage, totalUnconfirmPage}) {
    ...
    return (<>
        <StyledTable>
            <StyledTableHeadTr>
                <StyledTableCell width="30" minWidth={100} align="center">
                ...
                {/*</StyledTableCell>*/}
                <StyledTableCell width="43" align={lang === "en" ? "left" : "right"}>{t('comments:sentIn')}</StyledTableCell>
                <StyledTableCell width="5" minWidth={55} align="center">{t('translation:author')}</StyledTableCell>
                    ...
                    (<React.Fragment key={index}>
                        <StyledTr>
                            ...
                            {/*    <StyledCheckboxImgInTable minWidth="98">*/}
                                ...
                                {/*</StyledCheckboxImgInTable>*/}
                            {/*</StyledTableCell>*/}
                            <StyledTableCell width="30" align={lang === "en" ? "left" : "right"}>
                                <StyledCheckboxImgInTable minWidth="98">
                                <StyledCheckboxComponent
                                    change={(e) => isCheckedHandler(e, comment.cid)}
                                    checked={selectedCheckBoxes.includes(`${comment.cid}`)}/>
                            ...
                            <StyledTableCell width="43" align={lang === "en" ? "left" : "right"}>
                                <a href={comment.view_node}>{comment.title}</a>
                            </StyledTableCell>
                            <StyledTableCell width="5" minWidth={55} align="center">{comment.name}</StyledTableCell>
                            <StyledTableCell width="10" minWidth={55}
                                             align="center">{getJustDate(comment.last_updated,true)}</StyledTableCell>
                            <StyledTableCell width="12" minWidth={111} align="center">
