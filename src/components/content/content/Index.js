 ...
 */
export const setContentWhenEditButtonClicked = (id, setOpenRegisterForm, setContent, setImgAndUrl, setImgsAndUrls, setVideosAndUrl, setVoicesAndUrl, appContext, setContentType, setErrors,setSelectedTags) => {
    contentService.getContent(id, appContext.handleError).then((response) => {
        ...
        let defaultTagsArr=[];
        if (item.field_tags) {
            item.field_tags.map((item) => {
                defaultTagsArr.push({name: `${item.target_id}`,tid:`${item.target_id}`})
            })
...
export const handleCloseContentFormMethod = (setOpenRegisterForm, setId, setContent, setImgsAndUrls, setImgAndUrl, setVideosAndUrl, setVoicesAndUrl, setFilesPreviewUrl,
                                             setErrors,
                                             setContentType) => {
