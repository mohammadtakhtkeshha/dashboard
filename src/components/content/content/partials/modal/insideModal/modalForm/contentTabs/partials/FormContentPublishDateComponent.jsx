...
import {StyledTypographyError, StyledStatusButton, StyledStatusButtonBlock} from "assets/js/App";
...
function CategoryAndDescriptionComponent({t, contentype}) {
    ...
    return (<Grid container>
        <StyledGridPublishOnAndUnpublish className="publish-date" contentype={contentsContext.content.type[0].target_id} item xs={6}>
            <StyledGridBlock>
        ...
        <StyledGridPublishOnAndUnpublish className="unpublish-date" contentype={contentsContext.content.type[0].target_id} item xs={6}>
            <StyledGridBlock>
        ...
        <StyledGrid item xs={4} className="publish-status">
            ...
            <StyledGridBlock>
                <StyledStatusButtonBlock align={antiAlign}>
                    <StyledStatusButton value="true" status={contentsContext.content.status[0].value}
                                        onClick={handleStatusChange}>
                        {t('translation:active')}
                    </StyledStatusButton>
                    <StyledStatusButton value="false" status={contentsContext.content.status[0].value}
                                        onClick={handleStatusChange}>
                        {t('translation:notActive')}
                    </StyledStatusButton>
                </StyledStatusButtonBlock>
