...
export const uploadVideoMethod = (files, contentsContext, appContext) => {
    for (let e of files) {
        ...
        contentService.uploadVideo(e, appContext.handleError).then((response) => {
            ...
            contentsContext.setContent(prevState => {
                return {
                    ...prevState, field_video: [...prevState.field_video,{
...
export const uploadVoiceMethod = (files, contentsContext, appContext) => {
    for (let e of files) {
        ...
        contentService.uploadVoice(e,appContext.handleError).then((response) => {
            ...
            contentsContext.setContent(prevState => {
                return {
                    ...prevState, field_sound: [...prevState.field_sound, {
                        "target_id": item.fid[0].value,
                        "target_type": "file"
                    }]
                }
...
export const removeVideoMethod = (currentId, contentsContext) => {
    ...
    contentsContext.setContent(prevState => {
        return {
            ...prevState, field_video: filteredFieldVideo
        }
    });
...
export const removeVoiceMethod = (currentId, contentsContext) => {
    ...
    contentsContext.setContent(prevState => {
        return {
            ...prevState, field_sound: filteredFieldSound
        }
    });
...
export const removeMultiImgMethod = (e,contentsContext) => {
    ...
    contentsContext.setContent(prevState => {
        ...
        return {
            ...prevState, field_images_gallery: newImagesGallery
        }
    });
