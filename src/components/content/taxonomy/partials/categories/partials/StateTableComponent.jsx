...
function StateTableComponent({t, setOpenForm, ids, states, chunks, page, setStates, handlePagination, setIds, setChunks}) {
    ...
    const deleteState = (id) => {
        deleteStateMethod(id, t, states, appContext, setStates, handlePagination, setIds)
    }
    ...
    return (<Box>
            <StyledTable>
                <StyledTableHeadRow>
                    <StyledTableCell>{t('taxonomy:categoryList')}</StyledTableCell>
                </StyledTableHeadRow>
            </StyledTable>
