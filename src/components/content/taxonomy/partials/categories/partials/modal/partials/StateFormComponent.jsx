...
function StateFormComponent({t, openForm, closeForm,setOpenForm, states, setErrors,errors, category, setCategory, setStates,setIds,handlePagination}) {
    ...
    const register = () => {
        registerMethod(appContext, category, openForm, setOpenForm, setStates, t,setIds,handlePagination,closeForm,errors)
    }
    ...
    return (<>
            <StyledModalHeader>{t('taxonomy:newCategory')}</StyledModalHeader>
            <StyledModalBody>
                <StyledBottomMargin>
                    <Grid container>
                        <Grid item xs={12}>
                            <StyledLabel>{t('translation:name')}</StyledLabel>
                            <StyledInput value={category.name[0].value !== null ? category.name[0].value : ""} type="text"
                        ...
                        <Grid item xs={12}>
                            <StyledMarginTop>
                                ...
                                <StyledInput value={category.path[0].alias !== null ? category.path[0].alias : ""} type="text"
