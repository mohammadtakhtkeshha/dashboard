...
function StateTableComponent({t, setOpenForm, ids, states, chunks, page, setStates,setChunks,getStates}) {
    ...
    const deleteState = (id) => {
        deleteStateMethod(id, t, states, appContext, setStates,getStates)
    }
    ...
    return (<Box>
        <StyledTable>
            <StyledTableHeadRow>
                <StyledTableCell>{t('taxonomy:videoList')}</StyledTableCell>
            </StyledTableHeadRow>
        </StyledTable>
