...
import {getTaxonomyVideos} from "core/services/taxonomy/taxonomy.service";
...
export const getStatesMethod = (handleError, setStates, handlePagination, setIds) => {
    getTaxonomyVideos(handleError).then((response) => {
...
export const getStateMethod = (id, appContext, setState) => {debugger
    appContext.setLoading(true)
