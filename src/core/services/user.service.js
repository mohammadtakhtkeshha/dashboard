...
export const getRoles=(handleError)=> {
    return Method({method:'get',url:getRolesUrl,headers: authHeader(),handleError:handleError});
}

export const deleteUser=(id,handleError)=> {
    return Method({method:'delete',url:deleteUserAndGetUserForEditUrl(id),headers: authHeader(),handleError:handleError});

}

export const getUsers=(page,handleError)=> {
    return Method({method:'get',url:getUsersUrl(page),headers: authHeader(),handleError:handleError});

}

export const getNotPaginateUser=(handleError)=> {
    return Method({url: getNotPaginateUserUrl, headers:authHeader(),handleError:handleError});
}
...
export const getUser=(id,handleError)=> {
    return Method({method:'get',url:getUserUrl(id),headers:authHeader(),handleError:handleError});
}
...
export const registerChangePass=(body,handleError)=> {
    ...
    //     }
    // }
    return Method({method:'POST',url:changePassUrl,headers: cjajauthHeader(),body:body,handleError:handleError});
}
