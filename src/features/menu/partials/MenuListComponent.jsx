...
import {StyledActionsBlock, StyledActionButtons, StyledGreenButton} from 'assets/js/library/components/buttons'
...
function MenuListComponent({t, setOpenForm, menus, setMenus, getMenus, dynamicHeight, setDynamicHeight}) {
    ...
    return (<>
                            ...
                            title: (
                                <StyledTreeRow>
                                    ...
                                    <StyledActionsBlock>
                                        <StyledActionButtons
                                            permission="true"
                                            value={node.entity_id} onClick={confirmDeleteHandler}>
        ...
        <StyledGreenButton value="active" onClick={() => saveChangesMethod(setLoading, menus, mobileOrWeb)}>
