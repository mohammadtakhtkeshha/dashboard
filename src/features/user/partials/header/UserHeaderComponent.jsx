...
import {steps} from "./UserHeaderComponent.js";
import {StyledHelpButton} from "assets/js/library/pages/content/contentHeader";
import {get} from "libraries/local-storage";

function UserHeaderComponent({t, setOpenUserForm, setExpandedFilter}) {
    ...
    return (<StyledHead lang={lang}>
        ...
        />
        <StyledRelative>
            <StyledAddButton className="register-button" ref={refRegisterButton}
