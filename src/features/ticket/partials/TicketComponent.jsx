          ...
          <StyledAccordionDetails>
            <StyledBody>
              <TicketRegisterBody
                ...
                setErrors={setErrors}
              />
              <StyledRegisterButtonTicketReply onClick={registerReply}>{t('translation:register')}</StyledRegisterButtonTicketReply>
            </StyledBody>
          </StyledAccordionDetails>
        </StyledAccordion>
            ...
            replies.map((item, index) => (
              <StyledReplyBox key={index} align={item.admin !== '' ? true : false}>
                ...
                <StyledImageBlock>
                  ...
                  <StyledRoleBlock>
                    <BookmarkIcon />
                    <Typography component="span">{item.admin === '' ? t('translation:customer') : item.admin}</Typography>
                  </StyledRoleBlock>
