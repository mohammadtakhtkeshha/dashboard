                            ...
                            <React.Fragment key={index}>
                                <StyledTr>
                                    ...
                                    <StyledTableCell width="12" minWidth={111} align="center">
                                        ...
                                        {/*</StyledActionButtonBlock>*/}
                                        <StyledActionsBlock>
                                            <StyledActionButtons permission='restful post comment_delete_rest_resource'
                                                                 value={comment.cid}
                                                                 onClick={deleteComment}>
                                                <img src={deleteIcon} alt={comment.cid}/>
                                            </StyledActionButtons>
                                            <StyledActionButtons permission='true' value={comment.cid}
                                                                 onClick={showEditForm}>
                                                <img src={editIcon} alt={comment.cid}/>
                                            </StyledActionButtons>
                                            <StyledConfirmButton
                                                // commentStatusAndPermission={commentStatus === 'published' && permissions['restful post comment_status_rest_resource'].access}
                                                commentStatusAndPermission={!(commentStatus === 'published') && false}
                                                value={comment.cid}
                                                onClick={makeActiveHandler}>
                                                {t('translation:active')}
                                            </StyledConfirmButton>
