                ...
                <StyledPaper lang={lang}>
                    ...
                    <StyledDashboardTable>
                        <StyledTableHeadRow lang={lang}>
                            ...
                            <StyledTableCell align={leftRightAlign}
                                             width="90">{t('translation:subject')}</StyledTableCell>
                            <StyledTableCell width="5" align="center" minWidth="98">{t('translation:status')}</StyledTableCell>
                            <StyledTableCell width="5" align="center" minWidth={68}>{t('translation:date')}</StyledTableCell>
                        </StyledTableHeadRow>
                        <StyledTableBody>
                            {comments.length > 0 && comments.map((comment, index) =>
                                <a key={index} href={comment.link} target='_blank'>
                                    <StyledTableBodyRow key={index}>
                                        ...
                                        {/*</StyledTableCell>*/}
                                        <StyledTableCell align={leftRightAlign}
                                                         width="90"> {comment.subject}</StyledTableCell>
                                        ...
                                        <StyledTableCell width="5" align={leftRightAlign === 'left' ? "right":"left"} minWidth={68}> {comment.created}</StyledTableCell>
                                    </StyledTableBodyRow>
                                </a>
                            )}
                        </StyledTableBody>
