          ...
          <StyledPaper lang={lang}>
            ...
            <StyledDashboardTable>
              <StyledTableHeadRow lang={lang}>
                ...
                <StyledTableCell width="5" align={leftRightAlign === 'left' ? 'right' : 'left'} minWidth="57">
                  {t('translation:type')}
                </StyledTableCell>
                ...
                {contents.map((content, index) => (
                  <a key={index} href={content.view_node} target="_blank" rel="noopener noreferrer">
                    ...
                    <StyledTableBodyRow key={index}>
                      ...
                      <StyledTableCell width="5" minWidth="57" align={leftRightAlign === 'left' ? 'right' : 'left'}>
                        {' '}
                        {content.type}
                      </StyledTableCell>
                      <StyledTableCell width="5" minWidth={68} align={leftRightAlign === 'left' ? 'right' : 'left'}>
                        {' '}
                        {content.created}
                      </StyledTableCell>
                    </StyledTableBodyRow>
