...
import { StyledFlexBlock, ContentChartBlock } from 'assets/js/dashboard/partials/contentChart';
...
function ContentChartComponent({ t }) {
  ...
  useEffect(() => {
    getContentListMethod(setContents, setTotalLength, setLoading, setIsRequestSuccess);
  }, [setLoading]);

  return (
    <>
      {totalLength > 0 && isRequestSuccess && (
