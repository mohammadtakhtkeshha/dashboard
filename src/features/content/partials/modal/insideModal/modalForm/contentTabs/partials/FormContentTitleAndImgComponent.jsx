...
function FormContentTitleAndImgComponent({ t, contentype, newsCategory }) {
    ...
    useEffect(() => {//for filling edit partials
        const changeTagsByGettingContentMethod = (contentContext) => {
            const tagsArr = []
        ...
        changeTagsByGettingContentMethod(contentContext);

        const changeNewsCategoryByGettingContentMethod = (contentContext, setSelectedNewsCategory) => {
    ...
    return (
        <Grid container spacing={3}>
            <Grid item xs={6}>
                <Paper>
                    ...
                    <StyledInput type="text"
                        ...
                        className='title'
                        onChange={e => handleChangeMethodTitle(e, contentContext, t, contentContext.setContent)} />
            ...
            <StyledGridTagsBlock item contentype={contentype} className="tags" xs={12}>
                ...
                <MultiSelect array={contentContext.tags}
            ...
            <StyledGridSingleImg item contentype={contentype} className="image" xs={12}>
                <UploadImgComponent type='image'
                    getFileInParent={(e) => uploadImgMethod(e, 'single', contentContext, appContext)}
            ...
            <StyledGridNewsCategory contentype={contentype} item xs={4} className="news-category">
                ...
                {newsCategory.map(function (item, index) {
                    return (<StyledCheckboxBody key={index}>
