      ...
      <StyledModalBody>
          <Grid container>
            <Grid item xs={12}>
              ...
              />
              {errors.name && <StyledTypographyError align={lang === 'en' ? 'left' : 'right'}>{errors.name.required}</StyledTypographyError>}
            </Grid>
            ...
            <Grid item xs={12}>
                ...
                />
                {errors.path && <StyledTypographyError align={lang === 'en' ? 'left' : 'right'}>{errors.path.regex}</StyledTypographyError>}
            </Grid>
