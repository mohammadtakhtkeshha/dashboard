...
function NewWebformComponent({t, errors, closeForm, setErrors, webform, setWebform, isEditForm}) {
    ...
    return (<>
        ...
        <StyledModalFooter>
            <StyledRegisterButton status={isObjectEmpty(errors)}
                                  onClick={() => register(webform, setLoading, history, isEditForm, setErrors)}>
