...
function FormEditBtn({t, form, setForms,setOpenWebform,setWebform,forms,setIsEditForm}) {
    ...
    return (<div>
            ...
            <StyledMenu
                ...
                onClose={handleClose}>
                <StyledMenuItem permission="true">
                ...
                <StyledMenuItem permission={`${permissions['restful post delete_webform_rest_resource'].access}`} onClick={() => deleteForm(form.id)}>
                    {t('translation:delete')}
                </StyledMenuItem>
                <StyledMenuItem permission={`${permissions['restful patch form_edit_rest_resource'].access}`} onClick={()=>clickEditButton(form.id)}>
                    {t('webforms:editForm')}
                </StyledMenuItem>
            </StyledMenu>
        </div>
